...
%token IF ELSE FOR WHILE DO CONTINUE RETURN DOUBLE CASE DEFAULT PRINTLN BREAK SWITCH
%token ID CONST_INT CONST_FLOAT INT FLOAT CHAR VOID 
%token ADDOP MULOP LOGICOP RELOP INCOP DECOP ASSIGNOP NOT
%token COMMA SEMICOLON LPAREN RPAREN LTHIRD RTHIRD LCURL RCURL
...
program : program unit
	...
	| unit
	{
		...
		$$ = new symbol_info($1->getname(),"program unit");
	}
	;
...
statement : var_declaration
	...
	| IF LPAREN expression RPAREN statement ELSE statement
	{
		...
		outlog<<"if"<<$3->getname()<<$5->getname()<<$7->getname()<<endl<<endl;
			
		$$ = new symbol_info("if"+$3->getname()+$5->getname()+$7->getname(),"stmnt");
	}
	| WHILE LPAREN expression RPAREN statement
	{
		...
		$$ = new symbol_info("while("+$3->getname()+$5->getname()+")\n","stmnt");
	}
...
variable : ID
	...
	| ID LTHIRD expression RTHIRD
	{
		...
		outlog<<$3->getname()<<endl<<endl;
			
		$$ = new symbol_info("ID LTHIRD expression RTHIRD "+$3->getname(),"variable");
	}
	;
...
logic_expression : rel_expression
	...
	| rel_expression LOGICOP rel_expression
	{
		...
		$$ = new symbol_info($1->getname()+$3->getname(),"logic_expression");
	}
	;
...
rel_expression : simple_expression
	...
	| simple_expression RELOP simple_expression
	{
		...
		$$ = new symbol_info($1->getname()+$3->getname(),"rel_expression");
	}
	;
...
factor : variable
	...
	| ID LPAREN argument_list RPAREN
	{
		...
		$$ = new symbol_info($3->getname(),"factor");
	}
